...
async function uploadUpdateFiles(s3_key, s3_skey, new_version, app_dir, args) {
  if (!args) args = [];
...
async function setLatestVersion(s3_key, s3_skey, new_version, args) {
  if (!args) args = [];
...
async function setChance(s3_key, s3_skey, new_version, chance, args) {
  if (!args) args = [];
